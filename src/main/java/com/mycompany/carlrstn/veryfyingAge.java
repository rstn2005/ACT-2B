 ...
 * @author CL1-PC08
 */
public class veryfyingAge extends javax.swing.JFrame {

    /**
     * Creates new form veryfyingAge
     */
    public veryfyingAge() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(veryfyingAge.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new veryfyingAge().setVisible(true);
            }
        });
    }
